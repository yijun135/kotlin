...
class KotlinQuickDocumentationProvider : AbstractDocumentationProvider() {
    ...
    companion object {
        ...
        private fun renderKotlin(
            ...
            val deprecationProvider = ktElement.getResolutionFacade().frontendService<DeprecationProvider>()
        ...
        private fun renderDeprecationInfo(
            ...
            val deprecation = deprecationProvider.getDeprecations(declarationDescriptor).firstOrNull() ?: return ""
