...
public class DiagnosticsTestWithStdLibGenerated extends AbstractDiagnosticsTestWithStdLib {
    ...
    public static class Lateinit extends AbstractDiagnosticsTestWithStdLib {
        ...
        @TestMetadata("isInitializedAndReset.kt")
        public void testIsInitializedAndReset() throws Exception {
            String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/diagnostics/testsWithStdLib/lateinit/isInitializedAndReset.kt");
            doTest(fileName);
        }
    }
