...
class NamingContextImpl(
    ...
    private val objectInnerNameCache = mutableMapOf<DeclarationDescriptor, JsName>()
    ...
    override val objectInnerNames = object : Provider<DeclarationDescriptor, JsName> {
        override fun get(key: DeclarationDescriptor): JsName = objectInnerNameCache.getOrPut(key) {
