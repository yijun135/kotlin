...
abstract class LightClassGenerationSupport {
    ...
    abstract fun createDataHolderForScript(files: Collection<KtFile>, builder: LightClassBuilder): LightClassDataHolder.ForScript
    ...
    abstract fun findFilesForScript(scriptFqName: FqName, scope: GlobalSearchScope): Collection<KtFile>
