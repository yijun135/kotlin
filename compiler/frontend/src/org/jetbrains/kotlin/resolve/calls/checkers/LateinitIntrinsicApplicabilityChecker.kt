...
object LateinitIntrinsicApplicabilityChecker : CallChecker {
    ...
    override fun check(resolvedCall: ResolvedCall<*>, reportOn: PsiElement, context: CallCheckerContext) {
        ...
        // An optimization
        if (descriptor.name.asString().let { it != "isInitialized" && it != "reset" }) return
        ...
        if (!annotations.any { it.annotation.annotationClass!!.fqNameSafe == ACCESSIBLE_LATEINIT_PROPERTY_LITERAL }) return
    ...
    private fun isBackingFieldAccessible(descriptor: PropertyDescriptor, resolvedCall: ResolvedCall<*>, context: CallCheckerContext): Boolean {
